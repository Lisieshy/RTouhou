...
ne::Transform ne::whiteFerry::getTransform()
{
...
ne::Gravity ne::whiteFerry::getGravity()
{
    ne::Gravity grav;
...
ne::RigidBody ne::whiteFerry::getRigidBody()
{
    ne::RigidBody rigid;
...
ne::Color ne::whiteFerry::getColor()
{
    ne::Color temp;
...
ne::Alien ne::whiteFerry::getAlien()
{
    ne::Alien alienShot;
