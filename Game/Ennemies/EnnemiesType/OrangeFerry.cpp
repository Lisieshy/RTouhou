...
ne::Transform ne::OrangeFerry::getTransform()
{
...
ne::Gravity ne::OrangeFerry::getGravity()
{
    ne::Gravity grav;
...
ne::RigidBody ne::OrangeFerry::getRigidBody()
{
    ne::RigidBody rigid;
...
ne::Color ne::OrangeFerry::getColor()
{
    ne::Color temp;
...
ne::Skin ne::OrangeFerry::getSkin()
{
    ne::Skin skin;
...
ne::Alien ne::OrangeFerry::getAlien()
{
    ne::Alien alienShot;
